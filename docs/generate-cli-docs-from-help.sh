...
declare -a SCS_COMMANDS=("config-server-encrypt-value" "scs-stop" "scs-start" "service-registry-info" "service-registry-list" "service-registry-enable" "service-registry-deregister" "service-registry-disable")
